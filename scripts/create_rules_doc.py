...
add_checkbox(doc, "האם לקבוע מכסת כניסות חודשית ל־Open Gym, מעבר להגבלת התפוסה בכל משבצת.")
...
callout(
    doc,
    "המלצת סיום",
    "לאחר אישור יתר ההחלטות בסעיף 11, יש לעדכן את כללי הצהרת הבריאות, לחבר ספק SMS וספק סליקה, ולהריץ את סעיף 12 כבדיקות קבלה לפני פרסום לציבור.",
    "ok",
)
