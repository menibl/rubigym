...
export const RoleSwitcher: React.FC<RoleSwitcherProps> = ({
  ...
  return (
    <details className="bg-slate-900 text-white rounded-xl shadow-xl border border-slate-800 p-4 mb-6" id="role-switcher-container">
      <summary className="role-switcher-summary">
        <span>תצוגה פעילה: <strong>{activeUser.name}</strong></span>
        <span>החלפת משתמש / תפקיד</span>
      </summary>
