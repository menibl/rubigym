...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans antialiased" dir="rtl">
      {/* Visual Header */}
      <header className="bg-gradient-to-r from-zinc-950 via-zinc-900 to-amber-950 text-white shadow-md border-b border-amber-500/20">
      ...
      {/* Aesthetic Footer */}
      <footer className="bg-zinc-950 text-zinc-500 text-xs py-6 mt-12 border-t border-zinc-900">
